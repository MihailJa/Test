...
if ($path == 'auth.sendCode') call('POST', $method, $query, 'Session::phone_code');
    ...
    if ($path == 'notifications.get') call('GET', $method, $query, 'Notification::notifications_info');

    if ($path == 'notifications.read') call('POST', $method, NULL, 'Notification::notifications_read');
    // routes (not found)
